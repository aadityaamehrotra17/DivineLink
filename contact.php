    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item"><a class="nav-link active" href="https://manchestercentralmosque.org/" target="_blank" style="color: var(--swiper-theme-color);">Website</a></li>
                <li class="nav-item"><a class="nav-link" href="mailto:info@manchestermosque.org" target="_blank">Email</a></li>
                <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/mcmvictoriapark?locale=en_GB" target="_blank">Social</a></li>
            </ul>
        </div>
    </div><iframe allowfullscreen="" frameborder="0" loading="lazy" src="https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&zoom=10&q=Manchester+Central+Mosque" width="100%" height="400" style="height: 70vh;"></iframe>
